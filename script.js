document.addEventListener('DOMContentLoaded', function () {
    ...
    let rollNumberSelect = document.querySelector('#roll-number');
    let citySelect = document.querySelector('#city');

    students.forEach(function (student) {
        rollNumberSelect.innerHTML += `<option class="option" value="${student.id}">${student.id}</option>`;
        citySelect.innerHTML += `<option class="option" value="${student.details.city}">${student.details.city}</option>`;
    ...
    btn.addEventListener('click', function () {
        let rollNumber = rollNumberSelect.value;
        let selectedCity = citySelect.value;
        let selectedGender = document.querySelector('.nav>form input[name="gender"]:checked');

        let htmlContent = "";

        students.forEach(function (person) {
            if ((rollNumber === "Select ID" || person.id == rollNumber || rollNumber === "") &&
                (selectedCity === "Select City" || person.details.city === selectedCity || selectedCity === "") &&
                (selectedGender === null || person.details.gender === selectedGender.value)) {
